       ...
       var myChart = echarts.init(document.getElementById('browser_type')); 
        ...
        var option = {
                ...
                xAxis: [{
                    type: 'category',
                    boundaryGap: false,
                    data: ['Cidegas','Lizer','Kioshi','Faber','Worthington Nitin'],
                    axisLine: {
                        show: true,
                        onZero: true,
                        lineStyle: {
    ...
    options : [
        {
            ...
            legend: {
                ...
                orient:'vertical',
                padding: 0,
                data:['Cidegas','Lizer','Kioshi','Faber','Nitin']
            },
            toolbox: {
                show : true,
                color : ['#bdbdbd','#bdbdbd','#bdbdbd','#bdbdbd'],
                            ...
                            series : [
                                {
                                    ...
                                    data:[{value: 35,  name:'Cidegas'}, {value: 16,  name:'Lizer'}, {value: 27,  name:'Kioshi'}, {value: 29,  name:'Faber'}, {value: 12,  name:'Nitin'}]
                                }
                            ]
                    }, 
                {
                    series : [
                        {
                            name:'05-16',
                            type:'pie',
                            data:[{value: 42,  name:'Cidegas'}, {value: 51,  name:'Lizer'}, {value: 39,  name:'Kioshi'}, {value: 25,  name:'Faber'}, {value: 9,  name:'Nitin'}]
                        }
                    ]
                },
                {
                    series : [
                        {
                            name:'04-16',
                            type:'pie',
                            data:[{value: 29,  name:'Cidegas'}, {value: 16,  name:'Lizer'}, {value: 24,  name:'Kioshi'}, {value: 19,  name:'Faber'}, {value: 5,  name:'Nitin'}]
                        }
                    ]
                },
...
//clearInterval(timeTicket);
	...
	/*uncomment the following file to enable dashboard charts*/
