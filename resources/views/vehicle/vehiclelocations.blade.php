...
<!--class open creates background highlight------------------------------------>            
                        ...
                        @foreach ($treeitems as $node)
                            ...
                            <?php  
                            $highlightclass="";
                            if ($node->functionname=="Cylinder Locations")
                            {
                    ...
                    <div class='col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <!-- PAGE HEADING TAG - START --><h1 class="title">Cylinder locations</h1><!-- PAGE HEADING TAG - END -->                            </div>
