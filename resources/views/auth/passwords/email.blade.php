        ...
        <div class="container-fluid">
            <div class="login-wrapper row">
                ...
                <div id="login" class="login loginpage offset-xl-4 offset-lg-3 offset-md-3 offset-0 col-12 col-md-6 col-xl-4" >
                    ...
                    <form name="loginform" id="loginform" action="{{ route('password.email') }}" method="post">
                        {{ csrf_field() }}
                        <p>
                        ...
                        <p class="submit">
                            <input type="submit" name="wp-submit" id="wp-submit" class="btn btn-accent btn-block" value="{{ __('Send Password Reset Link') }}" />
                        </p>
